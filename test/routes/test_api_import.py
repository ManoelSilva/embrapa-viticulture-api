...
class TestApiImportRoutes(object):
    @pytest.fixture
    def app(self):
        ...
        api_routes = ApiImportRoutes(extractor_service)
    ...
    def test_get_table_grapes(self, app):
        ...
        with app_instance.app_context():
            ...
            response = client.get('/api/import/table_wines')
            assert response.status_code == 200
            assert response.get_json() == mock_data
            extractor_service.extract_data.assert_called_once_with(resource='import', sub_resource='table_wines',
                                                                   year=None)
    ...
    def test_get_sparkling(self, app):
        ...
        with app_instance.app_context():
            ...
            response = client.get('/api/import/sparkling')
            assert response.status_code == 200
            assert response.get_json() == mock_data
            extractor_service.extract_data.assert_called_once_with(resource='import', sub_resource='sparkling',
                                                                   year=None)
    ...
    def test_get_fresh_grapes(self, app):
        ...
        with app_instance.app_context():
            ...
            response = client.get('/api/import/fresh_grapes')
            assert response.status_code == 200
            assert response.get_json() == mock_data
            extractor_service.extract_data.assert_called_once_with(resource='import', sub_resource='fresh_grapes',
                                                                   year=None)

    def test_get_raisins(self, app):
        """
        Test the get_raisins method
        """
        app_instance, extractor_service = app
        mock_data = {'data': 'mocked raisins data'}
        extractor_service.extract_data.return_value = mock_data
        ...
        with app_instance.app_context():
            ...
            response = client.get('/api/import/raisins')
            assert response.status_code == 200
            assert response.get_json() == mock_data
            extractor_service.extract_data.assert_called_once_with(resource='import', sub_resource='raisins',
                                                                   year=None)
    ...
    def test_get_grape_juice(self, app):
        ...
        with app_instance.app_context():
            ...
            response = client.get('/api/import/grape_juice')
            assert response.status_code == 200
            assert response.get_json() == mock_data
            extractor_service.extract_data.assert_called_once_with(resource='import', sub_resource='grape_juice',
                                                                   year=None)
    ...
    def test_get_url_prefix(self):
        ...
        assert api_routes.get_url_prefix() == '/api/import'
    ...
    def test_get_blueprint_name(self):
        ...
        assert api_routes.get_blueprint_name() == 'api_import'
